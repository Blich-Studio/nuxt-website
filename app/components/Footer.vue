      ...
      <div :class="$style.grid">
        ...
        <div :class="$style.brand">
          ...
          <div :class="$style.socialLinks">
            ...
            <a href="#" :class="$style.socialLink">
              <!-- Mail -->
              <svg :class="$style.socialIcon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
.footer {
  ...
  // Light mode: warm cream card color with 50% opacity
  background-color: oklch(0.99 0.01 60 / 0.5);
}
